      ...
      <div>
        ...
        <div
          ...
          className="flex flex-col h-auto  lg:h-[69px]  
           lg:w-[400px]   md:w-[500px] md:h-[69px]  md:flex-row lg:flex-row items-center justify-between bg-white dark:bg-dark-gradient
        ...
        <div className="space-y-10">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between gap-8">
            ...
            {/* Unlimited Services */}
            <div className="dark:bg-dark-gradient p-6 rounded-2xl shadow-lg flex flex-col lg:flex-[2] space-y-8">
